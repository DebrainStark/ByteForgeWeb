...
const PortfolioHeader = () => {
  return (
    <section className="forge-hero-section portfolio-header py-5">
          ...
          <div className="col-lg-10">
            ...
            <h1 className="forge-title slide-in-element">
              <span className="title-line">
                <span className="metallic-text">Our <span className="highlight-word">Portfolio</span></span>
                <span className="accent-line"></span>
              </span>
              <span className="title-line-small delay-1">Explore our digital craftsmanship in action</span>
            </h1>
          </div>
        </div>
      </div>
