...
const ServicesHeader = () => {
  return (
    <section className="forge-hero-section services-header py-5">
          ...
          <div className="col-lg-10">
            ...
            <h1 className="forge-title slide-in-element">
              <span className="title-line">
                <span className="metallic-text">Our <span className="highlight-word">Services</span></span>
                <span className="accent-line"></span>
              </span>
              <span className="title-line-small delay-1">Crafted digital solutions for modern businesses</span>
            </h1>
            
            <div className="forge-ember-container">
              {/* Embers will be added dynamically with JavaScript */}
            </div>
          </div>
        </div>
      </div>
